        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            .on('receipt', async function (receipt) {
              ...
              const p1 = battles.p1CarId;
              let NFTPowerP2 = await window.contract.methods.monsters(id).call();
              let NFTPowerP1 = await window.contract.methods.monsters(p1).call();
              let nftAttackP1 = NFTPowerP1[7];
              let nftSpeedP1 = NFTPowerP1[9];
              let nftDefenseP2 = NFTPowerP2[8];
              let nftSpeedP2 = NFTPowerP2[9];
              if(winner == id) {
                Swal.fire({
                  // icon: 'success',
                  ...
                  html:`<div id="WanimationContainer">
                          ...
                          <div id="WinnerR">
                            ...
                            <ul style="font-size:10px">
                              <li>Attack P: ${nftAttackP1}</li>
                              <li>Speed: ${nftSpeedP1}</li>
                              <li>Total Power: ${Number(nftAttackP1)+Number(nftSpeedP1)}</li>
                            </ul>
                          </div>
                          ...
                          <div id="WinnerL">
                            <img src="${baseURI}${id}.png">
                            <ul style="font-size:10px">
                            <li>Defense P: ${nftDefenseP2}</li>
                            <li>Speed: ${nftSpeedP2}</li>
                            <li>Total Power: ${Number(nftDefenseP2)+Number(nftSpeedP2)}</li>
                            </ul>
                          </div>
                        </div>`,
                })
